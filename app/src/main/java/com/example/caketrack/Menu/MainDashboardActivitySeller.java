...
public class MainDashboardActivitySeller extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_dashboard_seller);
        ...
        // Fragmento inicial
        loadFragment(new FragmentCliente());
        ...
        bottomNavigation.setOnItemSelectedListener(item -> {
            ...
            if (id == R.id.nav_clientes_seller) {
        ...
        bottomNavigation.setSelectedItemId(R.id.nav_clientes_seller);
    }
