 ...
 * Use the {@link FragmentReservasPendientes#newInstance} factory method to
...
public class FragmentReservasPendientes extends Fragment {
    ...
    private PendientesAdapter reservaAdapter;
     ...
     * @return A new instance of fragment FragmentReservasPendientes.
     */
    // TODO: Rename and change types and number of parameters
    public static FragmentReservasPendientes newInstance(String param1, String param2) {
        FragmentReservasPendientes fragment = new FragmentReservasPendientes();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerReservas = view.findViewById(R.id.recyclerReservasPendientes);
        fabAgregar = view.findViewById(R.id.fabAgregarReservaPendientes);

        recyclerReservas.setLayoutManager(new LinearLayoutManager(getContext()));
        reservaAdapter = new PendientesAdapter(getContext(), listaReservas, listaUIDs);
        ...
        FirebaseDatabase.getInstance().getReference("reservas")
                ...
                .addOnSuccessListener(snapshot -> {
                    ...
                    for (DataSnapshot snap : snapshot.getChildren()) {
                        ...
                        if (r != null && r.getEstado() != null && r.getEstado().equalsIgnoreCase("pendiente")) {
                            listaReservas.add(r);
